...
public class BanguiMenu {
    ...
    public static void openBanguiMessagesMenu(Player player, OfflinePlayer target){
        ...
        ItemStack provocation = new ItemBuilder(Material.POTION, 1).setName("§6Provocation").setLore("§fProvocation envers un joueur", "§fsans insulter ou dénigrer.", "", "§a> §fClic gauche pour appliquer").toItemStack();
        ...
        ItemStack forbiddenLink = new ItemBuilder(Material.BARRIER, 1).setName("§6Lien interdit").setLore("§fEnvoi de lien interdit mais", "sans tentative de hack", "", "§a> §fClic gauche pour appliquer").toItemStack();
